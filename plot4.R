...
with(data,{
        ...
        plot(DateTime, Sub_metering_1, type="l", ylim=c(0,38), ylab= "Energy Sub metering", xlab="")
        par(new=TRUE)
        plot(DateTime, Sub_metering_2, type="l", col="red", ylim=c(0,38), xlab=NA,ylab=NA,frame=FALSE)
        par(new=TRUE)
        plot(DateTime, Sub_metering_3, type="l", col="blue", ylim=c(0,38), xlab=NA,ylab=NA,frame=FALSE)
